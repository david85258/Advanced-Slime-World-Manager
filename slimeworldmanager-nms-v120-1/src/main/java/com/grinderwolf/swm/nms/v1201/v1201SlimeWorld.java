...
public class v1201SlimeWorld extends AbstractSlimeNMSWorld {
    ...
    public v1201SlimeWorld(SlimeNMS nms, byte version, SlimeLoader loader, String name,
    ...
    public SlimeLoadedWorld createSlimeWorld(String worldName, SlimeLoader loader, boolean lock) {
        return new v1201SlimeWorld(nms, version, loader == null ? this.loader : loader, worldName, new Long2ObjectOpenHashMap<>(chunks), extraData.clone(),
